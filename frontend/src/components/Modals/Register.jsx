            ...
            <CustomModal isOpen={true}>
                <div className="2xl:w-3/12 w-full abeezee-regular grid space-y-2">
                    ...
                    <div className="bg-boxed mb-42 h-auto space-y-2 rounded-lg shadow-sm px-6 py-6">
                        <div>
                            <label htmlFor="" className="text-xs uppercase text-bright tracking-wider abeezee font-semibold">Email</label>
                            <input
                        ...
                        <div>
                            <label htmlFor="" className="text-xs uppercase text-bright tracking-wider abeezee font-semibold">Username</label>
                            <input
                                placeholder="john"
                                type="text"
                                className="focus:outline-none focus:ring-first focus:ring w-full px-3 py-3 rounded-md bg-inner text-sm text-white duration-200 transition-all"
                        ...
                        <div>
                            <label htmlFor="" className="text-xs uppercase text-bright tracking-wider abeezee font-semibold">Confirm Password</label>
                            <input placeholder="*******" type="text"
                                className="focus:outline-none focus:ring-first focus:ring w-full px-3 py-3 rounded-md bg-inner text-sm text-white duration-200 transition-all"
                            />
                        </div>
