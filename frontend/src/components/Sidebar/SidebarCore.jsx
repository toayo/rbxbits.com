        ...
        return <div className={`font-madimi bg-red flex flex-wrap h-full w-full border-r border-light`}>
            <section className="px-4 w-full">
                ...
                <section className="py-8 w-full">
                    <a href="/earn" className="text-sm flex transition-all duration-300 hover:shadow-md hover:scale-95 hover:bg-supreme shadow-none flex-wrap items-center text-center justify-center bg-first rounded-md w-full text-white py-3 focus:outline-none px-6 uppercase">
                        <span>
