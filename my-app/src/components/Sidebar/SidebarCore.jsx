                ...
                <section className="py-8 border-b border-light">
                    {
                        Object.keys(Games).map(g => {
                            ...
                            return <a href={game.Location} key={g} className="tracking-widest hover:scale-95 text-[15px] font-semibold transition-all duration-300 text-relaxed uppercase hover:text-first hover:cursor-pointer px-2 py-3 flex flex-wrap items-center space-x-2 text-sm rounded-md w-full">
                                <span className="">
                                    {game.Icon}
                                </span>
